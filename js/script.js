...
var $newsClone = $('.news').clone();

$('.filter2 a').click(function(e){
	$('.filter2 li').removeClass('current');	
	var $filterClass = $(this).parent().attr('class');
	if ( $filterClass == 'all' ) {
		var $filteredPortfolio = $newsClone.find('li');
	} else {
		var $filteredPortfolio = $newsClone.find('li[data-type~=' + $filterClass + ']');
	}
	$('.news').quicksand( $filteredPortfolio, { 
		duration: 800,
		easing: 'easeInOutQuad' 
	}, function(){
			$('.item a').hover( function(){ 
...
var $thesisClone = $('.masterthesis').clone();

$('.filter3 a').click(function(e){
	$('.filter3 li').removeClass('current');	
	var $filterClass = $(this).parent().attr('class');
	if ( $filterClass == 'all' ) {
		var $filteredPortfolio = $thesisClone.find('li');
	} else {
		var $filteredPortfolio = $thesisClone.find('li[data-type~=' + $filterClass + ']');
	}
	$('.masterthesis').quicksand( $filteredPortfolio, { 
		duration: 800,
		easing: 'easeInOutQuad' 
	}, function(){
			$('.item a').hover( function(){ 
